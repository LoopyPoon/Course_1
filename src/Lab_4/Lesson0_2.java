...
/* Пример класса, который преобразует строку в массив символов,
затем по номеру символа в кодовой таблице сдвигает его на величину,
указанную пользователем, и возвращает строку */

public class Lesson0_2 {
